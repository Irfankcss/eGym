...
namespace eGym.Migrations
{
    ...
    [Migration("20240804214826_ffds423")]
    partial class ffds423
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eGym.Data.Models.KorpaProizvod", b =>
                {
                    ...
                    b.HasOne("eGym.Data.Models.Slika", "SlikaProizvoda")
                        .WithMany()
                        .HasForeignKey("SlikaProizvodaId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
